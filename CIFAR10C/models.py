...
class DANNModel(torch.nn.Module):
    def __init__(self, in_dim=3, alpha=1., n_classes=10):
        super().__init__()
...
class ARMNet(torch.nn.Module):
    def __init__(self, in_dim=3, hidden_dim=128, n_classes=10):
...
class CC(torch.nn.Module):
    def __init__(self, n_domains=56, n_classes=10):
        super().__init__()
...
class DD(torch.nn.Module):
    def __init__(self, n_domains=56):
        super().__init__()
...
class MDANModel(torch.nn.Module):
    def __init__(self, in_dim=3, n_domains=56, n_classes=10):
        super().__init__()
