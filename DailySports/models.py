...
class DANNModel(torch.nn.Module):
    def __init__(self, in_dim=30, alpha=1., n_classes=19):
        super().__init__()
...
class MMDModel(torch.nn.Module):
    def __init__(self, in_dim=30, n_classes=19):
        super().__init__()
...
class ContextNet(torch.nn.Module):
    def __init__(self, in_dim=30, out_dim=1, hidden_dim=256):
        super().__init__()
...
class ARMNet(torch.nn.Module):
    def __init__(self, in_dim=31, hidden_dim=64, n_classes=19):
        super().__init__()
...
class CC(torch.nn.Module):
    def __init__(self, n_domains=6, n_classes=19):
        super().__init__()
...
class CP(torch.nn.Module):
    def __init__(self, n_domains=10, n_classes=19):
        super().__init__()
...
class MDANModel(torch.nn.Module):
    def __init__(self, in_dim=30, n_domains=6, n_classes=19):
        super().__init__()
        ...
        self.domain_classifier = torch.nn.ModuleList([torch.nn.Sequential(torch.nn.Linear(32, 128),
                                                                          torch.nn.ReLU(),
                                                                          torch.nn.Linear(128, 128),
                                                                          torch.nn.ReLU(),
                                                                          torch.nn.Linear(128, 128),
                                                                          torch.nn.ReLU(),
                                                                          torch.nn.Linear(128, 2)) for _ in range(self.n_domains)])
