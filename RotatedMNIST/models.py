...
class DANNModel(torch.nn.Module):
    def __init__(self, in_dim=1, alpha=1., n_classes=10):
        super().__init__()
...
class MMDModel(torch.nn.Module):
    def __init__(self, in_dim=1, n_classes=10):
        super().__init__()
...
class ARMNet(torch.nn.Module):
    def __init__(self, in_dim=1, hidden_dim=128, n_classes=10):
...
#-------------------------------------------------------------------
''' 
    MLDG model : Meta-Learning domain generalization
...
#-------------------------------------------------------------------
''' 
    DGER model : Domain generalization
...
class CC(torch.nn.Module):
    def __init__(self, n_domains=10, n_classes=10):
        super().__init__()
...
class MDANModel(torch.nn.Module):
    def __init__(self, in_dim=1, n_domains=10, n_classes=10):
        super().__init__()
